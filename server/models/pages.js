...
module.exports = {
  ...
  updatePageContentById(body){
     return queryHelper(`UPDATE pages SET title='${body.title}',
      page_description ='${body.description}',banner_location='${body.banner_location}', last_edited_by='${body.last_edited_by}', ckeditor_html = '${body.ckeditor_html}' where page_id = ${body.page_id};`)
     .then(response => response)
     .catch(e => {throw e})
  },
